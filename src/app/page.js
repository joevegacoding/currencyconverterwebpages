...
export default function Home() {
  return (
    <div className="mx-auto max-w-4xl px-4 py-8">
      ...
      <h3 className="my-4 text-xl font-bold">Interpretation</h3>
      <p className="my-4">
      ...
      <h3 className="my-4 text-xl font-bold">Definitions</h3>
      ...
      <ul className="list-disc ml-8">
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Currency Converter Plus.
          </p>
        </li>
        <li className="my-4">
          <p>
      ...
      <h2 className="my-4 text-2xl font-bold">Acknowledgment</h2>
      <p>
      ...
      <h2 className="my-4 text-2xl font-bold">Links to Other Websites</h2>
      <p className="my-4">
      ...
      <h2 className="my-4 text-2xl font-bold">Termination</h2>
      <p className="my-4">
      ...
      <h2 className="my-4 text-2xl font-bold">Governing Law</h2>
      <p className="my-4">
      ...
      <h2 className="my-4 text-2xl font-bold">Disputes Resolution</h2>
      <p className="my-4">
      ...
      <h2 className="my-4 text-2xl font-bold">For European Union (EU) Users</h2>
      <p className="my-4">
      ...
      <h2 className="my-4 text-2xl font-bold">Severability and Waiver</h2>
      <h3 className="my-4 text-xl font-bold">Severability</h3>
      <p className="my-4">
      ...
      <h3 className="my-4 text-xl font-bold">Waiver</h3>
      <p>
